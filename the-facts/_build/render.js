...
const renderToHtml = ({ frontmatter, body }) => {
...
const buildPageTitle = (titlePlain, fm) => {
...
const buildBreadcrumb = (titlePlain) => {
  return buildCrumbs([
    { label: 'Home', href: '/' },
 ...
 */
const renderTitleAccent = (mdTitle) => {
...
const renderCustomBlock = (cls, inner) => {
  switch (cls) {
 ...
 * hyphen all accepted.
 */
const hoistBlockquoteSources = (html) => {
 ...
 */
const extractReferences = (html, colophon) => {
