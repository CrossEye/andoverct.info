...
const scopeSelectorList = (selectors, scope) => {
  return selectors
    .split(",")
    .map((raw) => {
      const sel = raw.trim()
 ...
 */
const ensureSourceHtaccess = (srcPath) => {
...
export const buildSubpages = async (folder, meta, themeCss, baseCss, breadcrumb) => {
