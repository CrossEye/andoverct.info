---
section: aes
publicUrl: 'http://andoverct.info/reports/aes/data-privacy/'
pageTitle: 'When Small Numbers Become Names — Town of Andover, CT'
...
- **Markdown** (plain text, readable in any editor):
  [`preschool_data_privacy.md`](preschool_data_privacy.md)
- **PDF** (print-ready, fixed layout for distribution):
  [`preschool_data_privacy.pdf`](preschool_data_privacy.pdf)
