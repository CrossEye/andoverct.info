...
window.Directives = (() => {
  ...
  const require = (name) => {
    ...
    if (!(key in cache)) {
      ...
      registry[key](module, require)
      cache[key] = module.exports
    }
    return cache[key]
  }
  define("svg", (module, require) => {
'use strict'
...
module.exports = locmap
  ...
  define("datatable", (module, require) => {
'use strict'
