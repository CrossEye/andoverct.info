...
formats:
  - icon: "\U0001F310"
    title: HTML
    href: ./
    desc: Interactive version with formatted tables; best for on-screen reading.
  - icon: "\U0001F4C4"
    title: Markdown
    href: disavowal.md
    desc: 'Plain-text version; readable in any editor, ideal for copying elsewhere.'
  - icon: "\U0001F4D1"
    title: PDF
    href: disavowal.pdf
...
I have one question for the Republicans asking for my vote this year, and I
would rather put it to them directly than guess at the answer. The question is
whether they will publicly disavow Donald Trump: a statement in their own name
that he does not represent them and does not have their support.

That is not a question about a policy, a bill, or a vote in Hartford. It is a
question about the head of the party whose banner every one of these candidates
...
> name that he does not represent you and does not have your support. Not a
> comment on a single policy, and not a statement about the party in general.

Each letter disclosed that I co-chair the Andover Democratic Town Committee,
offered to publish the reply in full and unedited, offered to link an answer
given anywhere else instead, and invited correction if the candidate had already
answered publicly and I had missed it.

One paragraph appeared only in the letter to Sen. Fazio, noting that he has
discussed his own past votes for Mr. Trump and has said he would welcome Mr.
...
> heading. It does not mean the candidate has never spoken about Mr. Trump, and
> it does not mean a reply was not sent. Anyone who believes a row is wrong
> should write to me and I will correct it within 24 hours.
...
> answer to this question will be added here too, with a link to the original
> and an archived copy in case it moves.



Part 3 — What counts as an answer
---------------------------------

Every reply will be classified, and the classification stated plainly beside it,
on this scale:


### Disavowal ###

An unambiguous statement in the candidate's own name that Mr. Trump does not
represent them and does not have their support.


### Criticism ###

Objection to a specific act, decision, or policy, without withdrawal of support.
This is a real answer and will be published as one. It is not a disavowal, and
will not be described as one.


### Deflection ###

The question was answered with something else: a pivot to state issues, a
statement that the candidate does not agree with everything the President does,
...
answer, and an honest one. It will be published in the same words and given the
same prominence as any other.
...
Part 4 — What the public record already shows
---------------------------------------------
...
> from his 2020 to 2022 Senate campaigns. Behind the zeros: 2,172 distinct
> video frames read by optical character recognition, about 50,000 characters of
> distinct on-screen text recovered, and 72 minutes of advertising audio
> transcribed. Ms. Jennings has never run a political ad on Meta, so advertising
> contributes nothing to her row in either direction.
...
> has never mentioned Mr. Trump.

The count is the weak version of the finding. The stronger version is what the
advertising does discuss. Sen. Fazio's ads return repeatedly to immigration and
federal enforcement, at length and in his own voice, and reach for the phrase
"federal authorities" rather than the name of the President who directs them.
The single instance of the word "administration" in nearly an hour of recorded
audio refers to Gov. Lamont's.

Mr. Guidone came through a contested Republican primary between February and
August of this year, ran thirty-one ads, and criticized his opponent by
reference to his record and his tenure without either man's advertising touching
the President.

None of that is an accusation. It is the reason the question is worth asking
...
A reasonable objection is that no Republican could answer this question and
survive a primary, so asking it is a trap rather than an inquiry. The record
suggests otherwise.

Themis Klarides led the Republican caucus in the Connecticut House from 2015 to
2021. During her 2022 campaign for the United States Senate she said she had
not voted for Mr. Trump in 2020, casting a protest write-in for her predecessor
as caucus leader instead. She said it in her own name, in public, while seeking
her party's endorsement, and she won that endorsement on the first ballot with
about 57 percent of the delegates. She has never reversed it.

In December of that year, two former Republican leaders of the state Senate, Len
...
**The question is about the man, not the party.** Every candidate here runs
under Mr. Trump's banner because he leads their party. That is a fact about the
ballot, not an accusation about the candidate. What each of them thinks of him
...
having done so, in the same type as everyone else.

**Corrections are welcome and will be made quickly.** If a candidate has already
answered this question somewhere I have not looked, the correction belongs on
this page more than the omission does.
...
It is not a neutral document. I wrote it, I am a Democrat, and I would like
these candidates to answer. What is offered here is not the absence of a point
of view but a record specific enough that a reader who disagrees with me can
check every part of it.
...
- Steve Weir for CT, [steveweirforct.com](https://steveweirforct.com/)
- Jenn Jennings 4 Senate,
  [jennjennings4senate.com](https://jennjennings4senate.com/)
...
- Connecticut State Elections Enforcement Commission, committee registration
  filings (SEEC Form 1A), searchable at
  [seec.ct.gov](https://seec.ct.gov/Portal/eCRIS/eCrisSearch)
- Jenn Jennings 4 Senate, campaign contact page,
  [jennjennings4senate.com](https://jennjennings4senate.com/contact/)
- Ryan Fazio for Governor, campaign contact page,
...
- Connecticut Secretary of the State, Candidate Registration List for Election
  Year 2026
- CT News Junkie, coverage of the Republican state convention, May 16, 2026,
  [ctnewsjunkie.com](https://ctnewsjunkie.com/2026/05/16/ct-republicans-back-fazio-for-governor/)
...
- CT Mirror, May 7, 2022, on Themis Klarides and the Republican Senate
  endorsement,
  [ctmirror.org](https://ctmirror.org/2022/05/07/ct-gop-endorses-a-social-moderate-themis-klarides-for-us-senate/)
- CT News Junkie, December 7, 2022, on the Fasano and McKinney opinion piece,
  [ctnewsjunkie.com](https://ctnewsjunkie.com/2022/12/07/op-ed-mckinney-fasano-tell-spoiled-child-trump-to-get-lost/)

**Correspondence**

- Every letter, reply, and public answer relating to this question, with
  original sources: [correspondence](./correspondence/)
